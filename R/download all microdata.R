...
extra.files <- c("1986_scf86bs","6263_sfcc6263s")
extra.names <- c("scf1986_panel","sfcc1963_panel")

for(i = 1:length(extra.files)){
		scf.m <- read.scf( extra.files[i] )
		save.name <- paste0(extra.names[ i ], '.rda' )
		save(scf.m,file=save.name)
}
